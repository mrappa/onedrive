...
url_host= "https://1283570519971189.cn-hongkong.fc.aliyuncs.com/2016-08-15/proxy/onedriv1/onedriv1/"
#http触发器的接口url


access_key='LTAI4G2fqwaNWgtyywLZnSH7'#云账号的AccessKey
access_key_secret='vvQ4DSDQyQGqLo9crvN2Cljjp3EYCS'#云账号AccessKey的密码
oss_end_point= 'http://oss-cn-hongkong-internal.aliyuncs.com'#访问对象存储的endpoint
oss_bucket_name='onedriv1'#可以使用的对象存储桶名称
